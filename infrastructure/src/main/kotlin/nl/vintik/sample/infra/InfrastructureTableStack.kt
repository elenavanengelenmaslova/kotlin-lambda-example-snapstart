...
class InfrastructureTableStack(scope: Construct, id: String, props: StackProps) : Stack(scope, id, props) {
    init {
        val (tableName, productsTable) = createTable()
    ...
    private fun createTable(): Pair<String, Table> {
        val tableName = "Products-SnapStart-Example"
        val productsTable = Table.Builder.create(this, tableName)
            ...
            .build()
        return Pair(tableName, productsTable)
    }
}